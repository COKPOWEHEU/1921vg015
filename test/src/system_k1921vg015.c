...
// Fout1 = 10 000 000 Hz
	RCU->PLLSYSCFG0 =( 9 << RCU_PLLSYSCFG0_PD1B_Pos) |  //PD1B
					 ( 1 << RCU_PLLSYSCFG0_PD1A_Pos) |  //PD1A
...
// Fout0 = 60 000 000 Hz
	...
	RCU->PLLSYSCFG2 = 60; //50;         //FBDIV
#elif (HSECLK_VAL == 10000000)
#error disdabled in TEST version
// Fout0 = 50 000 000 Hz
// Fout1 = 10 000 000 Hz
	RCU->PLLSYSCFG0 =( 9 << RCU_PLLSYSCFG0_PD1B_Pos) |  //PD1B
